...
| Date              | Date / Datetime    | Date (and possibly time) when the transaction occurred                      |
| Customer_ID       | String / Integer   | Unique identifier for the customer who made the purchase                    |
...
| Price_per_Unit    | Float / Decimal    | Price of one unit of the product (in currency)                              |
| Total_Amount      | Float / Decimal    | Total cost of the transaction (Quantity × Price_per_Unit)                   |
